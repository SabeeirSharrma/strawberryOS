...
iso_name="strawberry-os-gui"
iso_label="STRAWBERRY_GUI_$(date +%Y%m)"
iso_publisher="Strawberry OS Contributors"
iso_application="Strawberry OS - GUI Mining Desktop"
...
file_permissions=(
  ...
  ["/usr/local/bin/strawberryd"]="0:0:755"
  ["/usr/local/bin/cpac"]="0:0:755"
)
